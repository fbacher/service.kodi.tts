...
class BaseEngineServiceSettings(BaseServiceSettings):
    # Attach all 'generic, prototype setting definitions to TTS service.
    ...
    def init_settings(cls):
        #
        # Most settings are defined and stored using TTS values. All services
        # must translate to/from these TTS values. This allows sharing of
        # values between players, engines, etc.
        #
