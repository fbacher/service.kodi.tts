...
class Constraints:
    """
        ...
        property_name is the same as property key used in Settings (ex. Settings.VOLUME)
    ...
    def minimum(self) -> float | int:
        ...
        """
        value: float = self._minimum * self._scale
        if self.integer:
            return int(value)
        return value
    ...
    def default(self) -> float | int:
        ...
        """
        value: float = self._default * self._scale
        if self.integer:
            return int(value)
        return value
    ...
    def maximum(self) -> float:
        ...
        """
        value: float = self._maximum * self._scale
        if self.integer:
            return int(value)
        return value
    ...
    def midpoint(self) -> float:
        ...
        return self._midpoint * self._scale
    ...
    def setSetting(self, value: float, backend_id: str) -> None:
        ...
        """
        value: int = int(float(value) / self._scale)
        if self.property_name:
    ...
    def in_range(self, value: float | int) -> bool:
        ...
        """
        value: int = int(value / self._scale)
