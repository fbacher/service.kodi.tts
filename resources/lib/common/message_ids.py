...
class MessageId(Enum):
    ...
    VOLUME_LABEL = 32014
    KEYMAP = 32030
    INSTALL_DEFAULT_KEYMAP = 32039
    INSTALL_CUSTOM_KEYMAP = 32040
    EDIT_CUSTOM_KEYMAP = 32041
    RESET_CUSTOM_KEYMAP_TO_DEFAULTS = 32042
    REMOVE_INSTALLED_KEYMAP = 32043
    ...
    SPEED_UP = 32055
    SLOW_DOWN = 32056
    UPDATED_KEYMAPS_IN_EFFECT = 32057
    FAILED_TO_UPDATE_KEYMAP = 32058
    KEYMAP_NO_CHANGE = 32059
    PERFORM_CONFIG_TASKS = 32060
    INSTALLING_BASIC_KEYMAP = 32061
    ENABLING_EXTENDED_HELP = 32062
    ENABLING_HINTS = 32063
    OPEN_CONFIG_DIALOG = 32064
    CONFIGURATION_COMPLETE = 32065
    ...
    DEFAULT_KEYMAP_INSTALLED_OK = 32113
    CUSTOM_KEYMAP_INSTALLED_OK = 32114
    CUSTOM_KEYMAP_RESET_TO_DEFAULTS = 32115
    KEYMAP_REMOVED = 32117
    PRESS_KEY_TO_ASSIGN = 32118
    TIMEOUT_IN_X_SECONDS = 32119
    ...
    ANY_PIPER_API = 32067
    COMPILED_PIPER_API = 32068
    PYTHON_PIPER_API = 32069
    HTTP_PIPER_API = 32070
    ...
    HIGH_QUALITY = 32348
    MEDIUM_QUALITY = 32349
    LOW_QUALITY = 32350
    X_LOW_QUALITY = 32351
    UNKNOWN_QUALITY = 32352
    ...
    SELECT_VOICE_FROM_GROUP = 32715

    # Used as a Menu Heading to select a TTS engine and voice
    # Ex. Available Voices for English
    AVAIL_VOICES_FOR_LANG = 32716
    AVAIL_VOICES_FOR_VOICE_ENGINE = 32717
    TTS_SETTINGS = 32720
    AVAILABLE_VOICES_FOR_GROUP = 32721
    CHOOSE_VOICE_FROM_GROUP = 32722
