...
class SpinexTopicModel(TopicModel):

    _logger: BasicLogger = module_logger

    def __init__(self, parent: BaseModel, parsed_spinex_topic: ParseTopic) -> None:
        clz = SpinexTopicModel
        if clz._logger is None:
            clz._logger = module_logger

        super().__init__(parent=parent, parsed_topic=parsed_spinex_topic)

    @property
    def parent(self) -> ForwardRef('SpinexTopicModel'):
        return self._parent
