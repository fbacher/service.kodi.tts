...
from gui.base_tags import AttribInfo, control_elements, ControlType, ElementType, Item
...
class BaseControl:
    ...
    def __init__(self, control_type: ControlType, win_dialog_id: int, id_val: int = None,
                 visible: bool = False):
        clz = type(self)
        ...
        self.parent_type: ControlType = None
        self.parent_id: int = None

        self.child_by_id: Dict[str, BaseControl] = {}
        self.child_ids_by_type: Dict[ControlType.name, List[int]] = {}
    ...
    def get_type(self) -> ControlType:
        return self.control_type

    def set_parent(self, parent: ForwardRef('BaseControl')) -> None:
        self.parent = parent

    def set_parent_ids(self, parent_type: ControlType, parent_id: int) -> None:
    ...
    def get_parent_ids(self) -> Tuple[ControlType, int]:
    ...
    def get_attribs(cls, el_current: ET.Element) ->List[AttribInfo]:
        ...
        for key in attrib_entry.keys():
            ...
            if tag == 'control' and key == 'type':
                control_type: ControlType = cls.get_control_type(el_current)
