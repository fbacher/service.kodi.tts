...
class BoolMessageType(Enum):
    """
    Predefined Messags to use in place of True/False.
    These values can appear as values for true_msg_id and false_msg_id in topics
    """
    YES = 32173
    NO = 32174
    ENABLED = 32338
