...
from gui.base_tags import control_elements, ControlElement, Item, ValueFromType
...
class ItemLayoutTopicModel(TopicModel):
    ...
    @property
    def parent(self) -> ForwardRef('ItemLayoutTopicModel'):
        return self._parent
