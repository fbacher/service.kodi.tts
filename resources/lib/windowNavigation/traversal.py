...
class WindowTraversal:
    ...
    def voice_focused_control(self):
        ...
        try:
            ...
            self._logger.debug_extra_verbose('WindowTraversal: current_window_id: {} name: {}'.
        ...
        try:
            ...
            self._logger.debug_extra_verbose('WindowTraversal: current_window_dialog_id: {} name: {}'
            ...
            pass
            self._logger.debug_extra_verbose('WindowTraversal: no current Window Dialog ID')
        ...
        try:
            ...
            pass
            self._logger.debug_extra_verbose('WindowTraversal: focused_control ID:{}'.format(control.getId()))
    ...
    def voice_control(self, control):
        ...
        if isinstance(control, xbmcgui.ControlButton):
            ...
            self._logger.debug_extra_verbose('WindowTraversal: ControlButton label: {}, label2: {}'
            ...
            # Can't get text type
            self._logger.debug_extra_verbose('WindowTraversal: ControlEdit label: {}, text: {}'
            ...
            self._logger.debug_extra_verbose('WindowTraversal: ControlList selectedPosition: {}, selectedItem: {}, type: {}'
                             .format(control_list.getSelectedPosition(),
                                     control_list.getSelectedItem(),
                                     item_type))
            if isinstance(item_type, xbmcgui.Control):
                self._logger.debug_extra_verbose('WindowTraversal: recursing for Control type')
            ...
            self._logger.debug_extra_verbose('WindowTraversal: ControlProgress percent complete: {}'
