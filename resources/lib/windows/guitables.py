...
winNames = {10000: 10000,  # Home
            ...
            10002: 10002,  # pictures Removed in v17 Krypton
            10003: 10003,  # filemanager
            10004: 10004,  # settings
            10005: 10005,  # music  ?
            10006: 10006,  # video Removed in v17 Krypton
            10007: 10007,  # systeminfo
            10011: 10011,  # screencalibration
            10012: 10012,  # picturessettings  Removed in v17 Krypton
            10013: 10013,  # programssettings  ?
            10014: 10014,  # weathersettings Removed in v17 Krypton
            10015: 10015,  # musicsettings Removed in v17 Krypton
            10016: 10016,  # systemsettings
            10017: 10017,  # videossettings Removed in v17 Krypton
            10018: 10018,  # servicesettings
            10019: 10019,  # appearancesettings Removed in v17 Krypton
            10020: 10020,  # scripts Removed in v10 Dharma
            10021: Messages.get_msg(Messages.LIVE_TV_SETTINGS),  # Live TV Settings
            10024: 10024,  # videofiles: Removed in Gotham
            10025: 10025,  # videolibrary (MyVideoNav?) Removed in v17 Krypton
            ...
            10113: 'mute bug',  # Removed in v17 Krypton
            ...
            10141: 1046,  # accesspoints Removed in V19 Matrix
            ...
            10501: 10501,  # musicfiles Removed in v16 Jarvis
            10502: 10502,  # musiclibrary Removed in v17 Krypton
            ...
            12009: 13327,  # karaoke Removed in v16 Jarvis
            12600: 12600,  # weather
...
def getWindowName(winID):
    ...
    if winID in winNames:
        ...
        if isinstance(name, int):
            name = xbmc.getLocalizedString(name)
    elif winID > 12999:
