...
CacheEntryInfo
    ...
    temp_voice_path: Temp path based on current_voice_path. Used during
        generation of the voice path and renamed to current_voice_path with
...
CacheEntryInfo = namedtuple('CacheEntryInfo',
                            'use_cache, current_audio_path, temp_voice_path,'
