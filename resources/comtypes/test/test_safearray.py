...
import datetime
import unittest
from ctypes import byref, c_double, c_long, POINTER, pointer, py_object, PyDLL
from ctypes.wintypes import BOOL
from decimal import Decimal

from comtypes import BSTR, IUnknown
from comtypes._safearray import SafeArrayGetVartype
from comtypes.automation import (_midlSAFEARRAY, VARIANT, VARIANT_BOOL, VT_ARRAY, VT_BSTR,
                                 VT_I4, VT_R4, VT_R8, VT_VARIANT)
