...
from comtypes import BSTR, COMError, COMMETHOD, GUID, IID, IUnknown, npsupport, STDMETHOD
...
_ctype_to_vartype = {
    ...
    # The MSDN docs for SafeArrayCreate() have a info that neither
    # VT_ARRAY not VT_BYREF may be set, this info is missing however
