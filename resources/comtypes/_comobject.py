...
from ctypes import (byref, c_long, c_void_p, FormatError, oledll, POINTER, pointer,
                    Structure, windll, WINFUNCTYPE)

from comtypes import _encode_idl, COMError, instancemethod, IPersist, ReturnHRESULT
...
from comtypes.hresult import (DISP_E_BADINDEX, DISP_E_MEMBERNOTFOUND, E_FAIL,
                              E_INVALIDARG, E_NOINTERFACE, E_NOTIMPL, RPC_E_CHANGED_MODE,
                              S_FALSE, S_OK)
