...
# generated by 'xml2py'
# flags '..\tools\windows.xml -m comtypes -m comtypes.automation -w -r .*TypeLibEx -r
# .*TypeLib -o typeinfo.py'
...
from comtypes.automation import (BSTR, DISPID, DISPPARAMS, DWORD, EXCEPINFO, HRESULT, IID,
                                 IUnknown, LCID, LONG, SCODE, UINT, VARIANT, VARIANTARG,
                                 VARTYPE, WCHAR, WORD)
